module github.com/gtonic/ws_wingman/wingman
...
require github.com/adrianliechti/wingman v0.0.0-00010101000000-000000000000

replace github.com/adrianliechti/wingman => ./
